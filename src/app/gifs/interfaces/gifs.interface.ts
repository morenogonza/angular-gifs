// To parse this data:
//
//   import { Convert, BusquedaGifsRespones } from "./file";
//
//   const busquedaGifsRespones = Convert.toBusquedaGifsRespones(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface BusquedaGifsRespones {
  data: Gif[];
...
export class Convert {
  public static toBusquedaGifsRespones(json: string): BusquedaGifsRespones {
    return cast(JSON.parse(json), r('BusquedaGifsRespones'));
  }

  public static busquedaGifsResponesToJson(
    value: BusquedaGifsRespones
  ): string {
    return JSON.stringify(uncast(value, r('BusquedaGifsRespones')), null, 2);
  }
}
...
const typeMap: any = {
  ...
  Title: ['dragon ball GIF', 'Dragon Ball GIF by TOEI Animation UK'],
  Type: ['gif'],
